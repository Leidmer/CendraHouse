...
<div class="box box_login shadow">
   ...
   <label for="code" class="mtop16">Codi de recuperació:</label>
   <div class="input-group">
    <div class="input-group-prepend">
        <div class="input-group-text"><i class="far fa-envelope-open"></i></div>
    </div>
        {!! Form::number('code', null, ['class'=> 'form-control', 'id' => 'email', 'required'])!!}
   </div>

   {!! Form::submit('Enviar la Contrasenya', ['class' => 'btn btn-success mtop16', 'id' => 'login'])!!}
   {!! Form::close() !!}
